...
setInterval(() => {
  ...
  console.table(
    ...
    " 4.",
    refHeight(target),
    ref1BottomToRef2Top(ref, target),
    refRightToScreenLeft(target),
    refLeftToScreenLeft(target),
    " 8.",
    refBottomToScreenTop(target),
    refTopToScreenTop(target),
    refRightToScreenRight(target),
    refLeftToScreenRight(target),
    "12.",
    refBottomToScreenBottom(target),
    refTopToScreenBottom(target)
    // cssSetter(),
    // scrollRegister(),
    // resizeRegister(),
    // alwaysStickLeft(),
